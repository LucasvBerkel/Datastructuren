public class MyHashMap extends MyHashEntry{
      ...
      MyHashMap() {
            table = new MyHashEntry[DEFAULT_TABLE_SIZE];
      ...
      public void put(int key, int value) {
            ...
            if ((table[hash] == null || hash == initialHash)
                  ...
                  table[indexOfDeletedEntry] = new MyHashEntry(key, value);
                  size++;
